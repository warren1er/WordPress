...
<label for="<?php echo $field_ids[ 'hide_current_post' ]; ?>"><?php esc_html_e( 'Do not list the current post?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>
...
<label for="<?php echo $field_ids[ 'hide_sticky_posts' ]; ?>"><?php esc_html_e( 'Do not list sticky posts?', 'recent-posts-widget-with-thumbnails' ); ?><br />
...
<label for="<?php echo $field_ids[ 'show_thumb' ]; ?>"><?php esc_html_e( 'Display post featured image?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>
